...
# The MangaStudio_Data folder is inside the manga-image-translator subdirectory
APP_SOURCE_DIR = os.path.join(BASE_DIR, "manga-image-translator", "MangaStudio_Data")
